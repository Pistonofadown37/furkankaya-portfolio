...
if (!window.supabase) {
    ...
    // Tasarım runtime yalnızca ana sitede yüklenir.
    // Yönetim panelinde content-tab.js gibi harici bir dosya yüklenmez.
    if (document.querySelector(".site-header")) {
        const script = document.createElement("script");
        script.src = new URL("./design-runtime.js?v=6", document.baseURI).href;
        script.defer = true;
