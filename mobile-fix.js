...
`;
    ...
    function start() {
        ...
        var observer = new MutationObserver(function () {
            ...
            /*
             * IMPORTANT: Do not append the same node on every mutation.
             * Re-appending it creates another mutation and can cause an
             * endless MutationObserver loop that makes the page appear
             * to stop loading. Only move it when it is not already the
