...
`;
    ...
    function forceMobileLayout() {
        ...
        document.querySelectorAll(".service-card > div:last-child").forEach(function (content) {
        ...
        if (contact) {
            contact.style.setProperty("display", "block", "important");
            contact.style.setProperty("width", "100%", "important");
            contact.style.setProperty("height", "auto", "important");
            contact.style.setProperty("min-height", "0", "important");
            contact.style.setProperty("overflow", "visible", "important");
        }
    ...
    if (document.readyState === "loading") {
        document.addEventListener("DOMContentLoaded", function () {
            start();
            forceMobileLayout();
            setTimeout(forceMobileLayout, 250);
