...
`;
    ...
    function enforceMobileLayout() {
        ...
        /* design-runtime writes grid-template-columns directly with !important.
           Therefore force the mobile service layout directly on the elements. */
        ...
        /* Make sure the sections after Services remain part of normal flow. */
        document.querySelectorAll(".contact-section, .site-footer").forEach(function (el) {
    ...
    function start() {
        ...
        /*
         * design-runtime.js creates/updates #fkDesignRuntimeStyle after
         * its Supabase request completes. Do NOT use MutationObserver here:
         * repeatedly moving our own <style> element can create a mutation loop
         * and make the page appear to stop rendering.
         *
         * Instead, wait briefly for the runtime style, move our stylesheet
         * after it once, then stop checking.
         */
        var attempts = 0;
        var timer = setInterval(function () {
            ...
            /* 6 seconds is enough for the async design settings request.
               After that, stop touching the DOM. */
            if (attempts >= 120) {
                clearInterval(timer);
            }
        }, 50);
